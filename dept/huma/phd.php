...
<div id="mining">
	<div class="container">
		<p class="display-4">PH.D. Programmes</p>
	</div>
</div>

<div class="academic">
	<div class="container">
		<h4 style="color: blue;">Department Offers PH.D. in following disciplines:</h4>
		<br>
		<h6><b><ul>
			<li>PH.D. in English</li>
			<li>PH.D. in Philosophy</li>
			<li>PH.D. in Sociology</li>
		</ul></b></h6>
	</div>
</div>
<?php
